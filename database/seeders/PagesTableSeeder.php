    ...
    public function run()
    {
        ...
        \DB::table('pages')->insert(array (
            ...
            array (
                ...
                'author_id' => 1,
                'title' => 'Hello re:Play',
                'excerpt' => 'Welcome to re:Play, the ultimate social gaming platform that brings friends and players together like never before!',
                ...
                'slug' => 'hello-replay',
                'meta_description' => 'Welcome to re:Play, the ultimate social gaming platform that brings friends and players together like never before! Step into a vibrant world where gaming meets social interaction, and embark on thrilling adventures that transcend traditional boundaries.',
