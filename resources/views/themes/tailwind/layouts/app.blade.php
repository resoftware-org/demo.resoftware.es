...
@endphp
<body class="max-h-screen overflow-y-hidden font-family-karla flex {{ $page_bg }} {{ $devbar_p }}">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        @include("theme::menus.app-mobile", ["menu" => $menu])
        ...
        <div class="w-full min-h-screen overflow-x-hidden border-t flex flex-col">
            ...
            @include('theme::partials.footer', ["withNavigation" => false])
