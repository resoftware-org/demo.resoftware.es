<div id="dropdown-cta" class="p-4 mt-6 mx-2 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
    ...
    <a class="text-sm text-blue-800 underline font-medium hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" href="{{ route('wave.settings', 'plans') }}">Upgrade your plan now</a>
</div>