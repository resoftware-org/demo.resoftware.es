...
<footer class="w-full bg-white text-right p-10 sm:mb-10">
    <div class="px-8 @if (!isset($withNavigation) || $withNavigation) {{'pt-16'}} @endif mx-auto lg:px-12 xl:px-16 max-w-7xl">
        ...
        <div class="flex flex-wrap items-start justify-between pb-20">
            <a href="#_" class="flex items-center w-auto text-lg font-bold md:w-1/6">
                @if(Voyager::image(theme('footer_logo')))
                    <img style="height: 5rem;" src="{{ Voyager::image(theme('footer_logo')) }}" alt="Company name">
                @else
                    <div class="relative flex items-center text-gray-500 leading-tighter">
                        ...
                        <span class="ml-4 text-3xl font-thin tracking-wide">{{ setting('site.title') }}</span>
                    </div>
                @endif
            </a>
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0">
                    <span>&copy; {{ date('Y') }} {{ setting('site.title', 'MilEstudios.es') }}</span>
                    <span>by&nbsp;</span><a href="https://resoftware.es" target="_blank" class="hover:text-wave-600 hover:underline">re:Software S.L.</a>
                    <span>, All rights reserved.</span>
                </li>
                <li class="lg:ml-6">
                    <a href="{{ route('reapp.page', ['page' => 'privacy-policy']) }}" class="relative inline-block text-black group">
                ...
                <li class="lg:ml-6">
                    <a href="{{ route('reapp.page', ['page' => 'terms-of-service']) }}" class="relative inline-block text-black group">
                        <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-0"></span>
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                <li>
                    <a href="https://facebook.com/resoftwaresl" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://instagram.com/ubc_digital" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://twitter.com/ubc_digital" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://github.com/resoftware-org" target="_blank" class="text-gray-600 hover:text-gray-900">
