                        ...
                        <div class="relative z-20 grid gap-6 px-5 py-6 bg-white sm:p-8 sm:gap-8">
                            <a href="{{ url('docs') }}" class="block px-5 py-3 -m-3 space-y-1 transition duration-150 ease-in-out hover:border-blue-500 hover:border-l-2 rounded-xl hover:bg-gray-100">
                                ...
                                <p class="text-xs leading-5 text-gray-500">
                                    Wondering how to build re:Play?
                                </p>
                            </a>
                            <a href="{{ route('wave.blog') }}" class="block px-5 py-3 -m-3 space-y-1 transition duration-150 ease-in-out hover:border-blue-500 hover:border-l-2 rounded-xl hover:bg-gray-100">
                                <p class="text-base font-medium leading-6 text-gray-900">
                                    From The Blog
                                </p>
                                <p class="text-xs leading-5 text-gray-500">
                                    Read the stories on our Blog
                                </p>
                            </a>
                        </div>
                    </div>
