...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if($edit){{ route('voyager.' . $bread . '.update', $dataTypeContent->id) }}@else{{ route('voyager.' . $bread . '.store') }}@endif" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('replay::form.title') }}
                                <span class="panel-desc"> {{ __('replay::form.title_sub') }}</span>
                            </h3>
